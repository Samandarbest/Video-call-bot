...
HOME_TEXT = "👋🏻 **Hello,[{}](tg://user?id={})**,\n\nI am a telegram **video streaming Bot**. \nI Can Stream Videos On Telegram Video  Chat. Made With ❤️ By @slytherin_king 😉!"
HELP_TEXT = """
🏷️ --**Setting Up**-- :
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons =  [
            [
                InlineKeyboardButton("UPDATE CHANNEL 📢", url="https://t.me/slytherin_king"),
                InlineKeyboardButton("SUPPORT GROUP 💬", url="https://t.me/slytherin_king"),
            ],
            [
                InlineKeyboardButton("MORE BOTS🤖", url="https://t.me/slytherin_king/8"),
                InlineKeyboardButton("SOURCE CODE📦", url="https:/slytherin_king/slytherin_king/slytherin_king"),
            ],
            [
        ...
        buttons =  [
            ...
            [
                InlineKeyboardButton("MORE BOTS🤖", url="https://t.me/slytherin_king/8"),
                InlineKeyboardButton("SOURCE CODE📦", url="https://slytherin_king"),
            ],
            [
